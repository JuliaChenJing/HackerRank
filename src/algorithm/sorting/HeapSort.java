...
public class HeapSort {
	 ...
	 * (or list), and is part of the selection sort family. Although somewhat
	 * slower in practice on most machines than a well-implemented quicksort, it
	 ...
	 * 
	 * Here is the source code of the Java Program to implement Heap Sort. The
