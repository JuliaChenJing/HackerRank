...
public class StringSortWith2GB {
	 ...
	 * Solution: 
	 * 
	 * When an interviewer gives a size limit of 2GB, it should tell
	 ...
	 * 
	 *  1. Divide the file into K chunks, where X * K = 2 GB.
	 *   Bring each chunk into memory and sort the
	 * lines as usual using any O(n log n) algorithm. Save the lines back to the
	 * file. 
	 * 
	 ...
	 * 
	 * Step 3 is known as N-way merge The rationale behind using
	 * external sort is the size of data. Since the data is too huge and we
	 * can’t bring it all into memory, we need to go for a disk based sorting
	 * algorithm.
	 */
