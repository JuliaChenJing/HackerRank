...
public class FindNth {
	 ...
	 * 
	 * Algorithm: 
	 * 1.Create two pointers, p1 and p2, then point to the beginning of the node.
	 * 
	 ...
	 * 
	 *  3. Check for p2->next == null if yes return value of p1, otherwise increment p1 and
	 * p2. If next of p2 is null it means p1 points to the nth node from the
	 * last as the distance between the two is n. 
	 * 
	 * 4. Repeat Step 3.
	 */
