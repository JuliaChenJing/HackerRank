...
public class BinarySearchTree {
	...
	public static void main(String[] args) {
		...
		Node testNode = null, succNode = null;
		...
		// Find the in order successor of testNode
		succNode = tree.findInOrderSuccessor(testNode);

		// Print the key of the successor node
		if (succNode != null) {
			System.out.println("Inorder successor of node " + testNode.key + " is node " + succNode.key);
		} else {
			System.out.println("Inorder successor node does not exist");
		}
	}
