...
public class MoreBrackestNeeded {
	 ...
	 * moreBracketsNeeded that takes a bracket string as an input and returns
	 * the minimum number of brackets you’d need to add to the input in order to
	 * make it correctly matched.
	 */
	static int moreBracketsNeeded(String text) {
		int result = 0;
	...
	public static void main(String[] args) {
		System.out.println(moreBracketsNeeded("())("));// 2
		System.out.println(moreBracketsNeeded("())"));// 1
		System.out.println(moreBracketsNeeded("()"));// 0
	}
}
