...
class AddRequest {
	 ...
	 * 
	 * 1 How do we know if someone is online—I mean, really, really know? While we
	 * would like users to tell us when they sign o#, we can’t know for sure. A
	 * user’s connection might have died, for example. To make sure that we know
	 * when a user has signed o#, we might try regularly pinging the client to
